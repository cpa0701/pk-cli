<template>
  <div class="table-container">
    ...
    <Drawer
      ...
      class="drawer"
    >
      <add-drawer ref="userAddDrawer" :is-show.sync="isAddDrawerShow"></add-drawer>
    </Drawer>
    <!-- 修改弹框 -->
    <Drawer
...
import addDrawer from './form/addDrawer'
...
export default {
  ...
  methods: {
    ...
    fetchRemoveSelectList(params) {
      // const param = {
      //   uid: params
      // }
      this.$refs.baseTable.changePage(1)
    }
  }
}
</script>
